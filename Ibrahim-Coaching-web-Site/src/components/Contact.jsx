...
const Contact = () => {
  ...
  return (
    ...
    <section className="my-32" id='contact'>
        <div className="ml-10 lg:mx-auto max-w-2xl sm:text-center w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
            <div className="relative -m-10 lg:mb-2">
                <h1
                    className="absolute -top-16 left-64 lg:text-[80px] text-gray-900 font-bold opacity-5 lg:block hidden">
                    Contact
                </h1>
    ...
    <div className="max-w-6xl mx-auto bg-blue-900 bg-opacity-95 mt-20 rounded-lg">
        ...
        <div className="grid md:grid-cols-2 items-center gap-16 sm:p-10 p-4 font-[sans-serif]">
            <div>
                ...
                <ul className="flex mt-12 space-x-4">
                    <li className="bg-blue-600 hover:bg-blue-500  h-10 w-10 rounded-full flex items-center justify-center shrink-0">
            ...
            <div className=" p-6 rounded-lg">
                <form className="mt-8 space-y-4">
                    ...
                    <button  className="inline-flex items-center justify-center w-full px-4 py-2 text-gray-100 bg-transparent border border-white rounded-3xl hover:bg-white hover:text-black">
