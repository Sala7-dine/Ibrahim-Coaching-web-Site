...
const Footer = () => {
  ...
  return (
    <footer class="bg-blue-900 py-12 px-16 font-[sans-serif]">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="flex items-center lg:justify-center">
          <a href='javascript:void(0)'><img src={logo} alt="logo" class='w-32' /></a>
        </div>
      </div>
      <hr className="my-10 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-100 to-transparent opacity-100" />
