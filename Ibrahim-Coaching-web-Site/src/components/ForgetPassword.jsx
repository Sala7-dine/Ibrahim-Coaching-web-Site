  ...
  const emailRef = useRef();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError("Feild to reset password");
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 mt-24">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          {message && <div className="mt-5 w-full justify-center text-center rounded-md bg-green-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm" role="alert">
          {message} </div> }
        </div>
