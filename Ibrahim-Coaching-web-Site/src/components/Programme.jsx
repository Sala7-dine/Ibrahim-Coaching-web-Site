...
const Programme = () => {
  return (
    <section className="bg-white py-7 sm:py-32 lg:mt-28" id='programme'>
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative">
                        ...
                        <h1 className="pl-16 text-3xl font-bold border-l-8 border-indigo-600 md:text-5xl">
                            au programme
                        </h1>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-400 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          ...
          Je vais te donner EN 3 JOURS LES CLÉS POUR <strong>  PERDRE DU GRAS RAPIDEMENT ET EFFICACEMENT </strong>, te sentir <strong> BIEN DANS TA PEAU, TE TONIFIER et EXPLOSER TA CONFIANCE </strong> . Tu vas emprunter le même chemin que moi pour te sentir bien dans ton corps et dans ta tête.
            ...
            <div className="mt-5 flex items-center gap-x-4">
              <h4 className="flex-none text-sm font-semibold leading-6 text-indigo-600">Durant ces 3 JOURS je vais t'expliquer :
